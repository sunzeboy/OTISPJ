...
public protocol SZDropDownMenuDelegate:class{
    func dropDownMenu(_ menu:SZDropDownMenu!, didInput text:String!)
    func dropDownMenu(_ menu:SZDropDownMenu!, didChoose index:Int)
}

@IBDesignable open class SZDropDownMenu: UIView , UITableViewDataSource ,UITableViewDelegate,UITextFieldDelegate{
    ...
    private func setup() {
        ...
        pullDownButton.addTarget(self, action: #selector(SZDropDownMenu.showOrHide), for: .touchUpInside)
