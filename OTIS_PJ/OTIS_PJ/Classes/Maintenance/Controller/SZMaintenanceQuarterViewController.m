//
//  SZMaintenanceQuarterViewController.m
//  OTIS_PJ
//
...
@interface SZMaintenanceQuarterViewController ()<UITableViewDataSource>
...
@implementation SZMaintenanceQuarterViewController
// 懒加载
- (NSMutableArray *)maintenanceOperation {
    ...
    if (_maintenanceOperation == nil) {
        ...
        if (self.isFixMode) {
            ...
            NSMutableArray *arrayAll = [NSMutableArray arrayWithArray:[SZModuleQueryTool quaryOtherMaintenanceItemWithDetialItem:self.item2 andTimeType:OTISMaintenanceItemTimeTypeQuarterly]];
            ...
            NSMutableArray *arrayTemp = [NSMutableArray arrayWithArray:[SZModuleQueryTool quaryOtherMaintenanceItemWithDetialItem:self.item andTimeType:OTISMaintenanceItemTimeTypeQuarterly]];
