...
@interface SZPageViewController ()<UIScrollViewDelegate,MenuViewDelegate,NSCacheDelegate>

@property (nonatomic,strong)SZMenuView *MenuView;
...
- (void)loadMenuViewWithTitles:(NSArray *)titles {
    SZMenuView *Menview = [[SZMenuView alloc]initWithMneuViewStyle:self.style AndTitles:titles];
...
- (void)viewWillLayoutSubviews {
    ...
    self.MenuView.frame = CGRectMake(0, y+20, ScreenWidth, MenuHeight);
