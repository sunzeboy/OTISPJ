...
//                if (item1.PUINo) {
//                    
//                    BOOL ret = [db executeUpdateWithFormat:@"INSERT INTO t_LaborHours (GenerateDate, CreateTime, CreateDate,UpdateTime,Hour1Rate,Hour15Rate,Hour2Rate,Hour3Rate,ScheduleId,EmployeeId,LaborTypeId,Property,GroupId,PUINo) VALUES (%@,%@,%@,%@,%@,%@,%@,%@,%d,%@,%d,%d,%d,%@);",item1.GenerateDate,[NSDate currentTime],[NSDate currentDate],item1.UpdateTime,item1.Hour1Str,item1.Hour15Str,item1.Hour2Str,item1.Hour3Str,(int)scheduleID,strEmployeeID,item.LaborTypeID,0,0,item1.PUINo];
//                    if (ret) {
//                        
//                    }else{
//                        SZLog(@"t_LaborHours插入失败！！！");
...
//                }else{
//                    
//                    BOOL ret = [db executeUpdateWithFormat:@"INSERT INTO t_LaborHours (GenerateDate, CreateTime, CreateDate,UpdateTime,Hour1Rate,Hour15Rate,Hour2Rate,Hour3Rate,ScheduleId,EmployeeId,LaborTypeId,Property,GroupId) VALUES (%@,%@,%@,%@,%@,%@,%@,%@,%d,%@,%d,%d,%d);",item1.GenerateDate,[NSDate currentTime],[NSDate currentDate],item1.UpdateTime,item1.Hour1Str,item1.Hour15Str,item1.Hour2Str,item1.Hour3Str,(int)scheduleID,strEmployeeID,item1.LaborTypeId,item1.Property,0];
//                    if (ret) {
//
//                    }else{
//                        SZLog(@"t_LaborHours插入失败！！！");
...
//            }else{
//                SZLaborHoursItem *item1 = [[SZLaborHoursItem alloc] init];
//                BOOL ret = [db executeUpdateWithFormat:@"INSERT INTO t_LaborHours (GenerateDate, CreateTime, CreateDate,UpdateTime,Hour1Rate,Hour15Rate,Hour2Rate,Hour3Rate,ScheduleId,EmployeeId,LaborTypeId,Property,GroupId) VALUES (%@,%@,%@,%@,%@,%@,%@,%@,%d,%@,%d,%d,%d);",item1.GenerateDate,[NSDate currentTime],[NSDate currentDate],item1.UpdateTime,item1.Hour1Str,item1.Hour15Str,item1.Hour2Str,item1.Hour3Str,(int)scheduleID,strEmployeeID,item.LaborTypeID,item1.Property,0];
//                if (ret) {
//                    SZLog(@"t_LaborHours插入成功！！！");
//                }else{
//                    SZLog(@"t_LaborHours插入失败！！！");
...
//            if (item.item2.LaborTypeId) {
//                SZLaborHoursItem *item2 = item.item2;
//                BOOL ret1 = [db executeUpdateWithFormat:@"INSERT INTO t_LaborHours (GenerateDate, CreateTime, CreateDate,UpdateTime,Hour1Rate,Hour15Rate,Hour2Rate,Hour3Rate,ScheduleId,EmployeeId,LaborTypeId,Property,GroupId) VALUES (%@,%@,%@,%@,%@,%@,%@,%@,%d,%@,%d,%d,%d);",item2.GenerateDate,[NSDate currentTime],[NSDate currentDate],item2.UpdateTime,item2.Hour1Str,item2.Hour15Str,item2.Hour2Str,item2.Hour3Str,(int)scheduleID,strEmployeeID,item2.LaborTypeId,item2.Property,0];
//                if (ret1) {
//                    SZLog(@"t_LaborHours插入成功！！！");
//                }else{
//                    SZLog(@"t_LaborHours插入失败！！！");
...
//                SZLaborHoursItem *item2 = item.item2;
//                if ([SZTable_LaborType quaryLuTuLaborTypeIDWithLaborTypeID:item.LaborTypeID]) {
//                    BOOL ret1 = [db executeUpdateWithFormat:@"INSERT INTO t_LaborHours (GenerateDate, CreateTime, CreateDate,UpdateTime,Hour1Rate,Hour15Rate,Hour2Rate,Hour3Rate,ScheduleId,EmployeeId,LaborTypeId,Property,GroupId) VALUES (%@,%@,%@,%@,%@,%@,%@,%@,%d,%@,%d,%d,%d);",item2.GenerateDate,[NSDate currentTime],[NSDate currentDate],item2.UpdateTime,item2.Hour1Str,item2.Hour15Str,item2.Hour2Str,item2.Hour3Str,(int)scheduleID,strEmployeeID,[SZTable_LaborType quaryLuTuLaborTypeIDWithLaborTypeID:item.LaborTypeID],item2.Property,0];
//                    if (ret1) {
//                        SZLog(@"t_LaborHours插入成功！！！");
//                    }else{
//                        SZLog(@"t_LaborHours插入失败！！！");
