...
+(void)storaget_JHA_TYPE
{
    ...
    [OTISDB inDatabase:^(FMDatabase *db) {
        ...
        BOOL ret = [db executeUpdateWithFormat:@"INSERT INTO t_JHA_TYPE (JhaTypeId, Name, CardType) VALUES (1, '机房', 0),(2, '轿顶和井道', 0),(3, '底坑', 0),(1, '扶梯上舱', 4),(1, '扶梯上舱', 5),(1, '扶梯上舱', 6),(1, '扶梯上舱', 20),(1, '扶梯上舱', 21),(1, '扶梯上舱', 22),(1, '扶梯上舱', 33),(2, '扶梯倾斜段', 4),(3, '扶梯倾斜段', 5),(2, '扶梯倾斜段', 6),(2, '扶梯倾斜段', 20),(2, '扶梯倾斜段', 21),(2, '扶梯倾斜段', 22),(2, '扶梯倾斜段', 33),(3, '扶梯下机舱', 4),(3, '扶梯下机舱', 5),(3, '扶梯下机舱', 6),(3, '扶梯下机舱', 20),(3, '扶梯下机舱', 21),(3, '扶梯下机舱', 22),(3, '扶梯下机舱', 33);"];
        if (ret) {
