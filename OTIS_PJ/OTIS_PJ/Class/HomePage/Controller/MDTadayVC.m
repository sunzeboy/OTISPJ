...
@interface MDTadayVC ()<UITableViewDelegate,MDMaintainLiftViewDelegate>
...
-(void)setTempData{
    ...
    model1.liftNo=@"79NH5879";
    model1.dateStr=@"2017-02-10";
    model1.mounth=@"2月下半月";
    model1.address=@"麦购休闲广场";
